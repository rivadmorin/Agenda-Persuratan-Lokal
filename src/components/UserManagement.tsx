              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4.5 py-2.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-sm font-semibold text-slate-800 dark:text-white focus:outline-none focus:border-blue-500 focus:bg-white dark:focus:bg-slate-900 disabled:opacity-55 disabled:cursor-not-allowed font-mono transition-all"
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    {dialogMode === 'edit' && (
                      <span className="text-[10px] text-slate-400 dark:text-slate-500 font-semibold italic">Kosongkan jika tidak diubah</span>
                    )}
                  </div>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-2.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-sm font-semibold text-slate-800 dark:text-white focus:outline-none focus:border-blue-500 focus:bg-white dark:focus:bg-slate-900 transition-all"
                      placeholder={dialogMode === 'add' ? 'Initial password' : 'New password'}
                    />
                  </div>
                </div>
