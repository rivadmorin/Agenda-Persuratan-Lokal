                  ...
                  return (
                    <div key={col.key} className="w-full">
                      <md-outlined-text-field
                        ...
                        oninput={(e: any) => handleMetadataChange(col.key, e.target.value, col.type)}
                        className="w-full"
            ...
            <div className="p-6 border-t border-slate-150 dark:border-slate-800 flex items-center justify-end gap-3 bg-slate-50 dark:bg-slate-950/50">
              <md-outlined-button
                ...
                style={{
                  ...
                  '--md-outlined-button-label-text-font': 'var(--font-sans)',
              ...
              >
                {loading ? (
                  <span className="flex items-center gap-1.5">
                    <md-circular-progress indeterminate style={{ '--md-circular-progress-size': '18px', '--md-circular-progress-active-indicator-color': '#ffffff' } as React.CSSProperties} />
                    <span>Menyimpan...</span>
                  </span>
                ) : (
                  'Simpan Agenda'
